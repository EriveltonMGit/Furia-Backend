...
router.get("/verify-identity", (req, res) => {
  res.send(
    'Esta rota é para verificar a identidade. Use o método POST com um token JWT válido (via cookie ou header Authorization) e os campos "idDocument" e "selfie" no formato multipart/form-data.',
  )
})
